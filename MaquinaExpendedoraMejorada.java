public class MaquinaExpendedoraMejorada {
     ...
     */
    public MaquinaExpendedoraMejorada(int precioDelBillete, String origen, String destino, boolean maquinaPremio){
    ...
    public MaquinaExpendedoraMejorada(boolean maquinaPremio){
        precioBillete = 20;
        estacionOrigen = "Leon";
